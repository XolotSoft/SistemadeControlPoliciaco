...
namespace SistemadeControlPoliciaco
{
    public class Conexion
    {
        ...
        {
            SqlConnection conectado = new SqlConnection(@"Data Source=(LocalDB)\v11.0;Integrated Security=True;AttachDbFileName= C:\Users\bluedemonjr\Documents\Visual Studio 2013\Projects\SistemadeControlPoliciaco\SistemadeControlPoliciaco\bdSCP.mdf");
            conectado.Open();
            return conectado;
        }
